...
public class SQLiteOpenHelperOnDowngradeTest implements ISupportTest {
  @Override
  public TestResult run() {
    ...
    helper.getWritableDatabase();
    result.setResult(callback.onDowngradeCalled);
    helper.close();
